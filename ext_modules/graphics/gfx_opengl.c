...
static void gfx_opengl_set_viewport(int x, int y, int width, int height) {
    glViewport(gfx_viewport.x + x, gfx_viewport.y + y, width, height);
}

static void gfx_opengl_set_scissor(int x, int y, int width, int height) {
    glScissor(gfx_viewport.x + x, gfx_viewport.y + y, width, height);
}
...
static void gfx_opengl_start_frame(void) {
    ...
    glScissor(gfx_viewport.x, gfx_viewport.y, gfx_viewport.width, gfx_viewport.height);
...
void gfx_opengl_end_frame(void) {
